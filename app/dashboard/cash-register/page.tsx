import { getCashRegisterClosures } from "@/lib/actions/cash-register"
import { Button } from "@/components/ui/button"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import { Plus, Calendar, User, DollarSign, TrendingUp } from "lucide-react"
import Link from "next/link"

export default async function CashRegisterPage() {
  const closures = await getCashRegisterClosures()
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Gestiona los cierres de caja por turno o día
          </p>
        </div>
